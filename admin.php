...
<body>
	<div class="container">
      ...
      <a href="index.php"><button type="button"  id="btn"><i class=""></i>Logout</button></a>
      </ul>
		</div>
		<div class="timkiem">
      <ul>
  ...
  <div class="content2">
    <div class="item">
      <a href="https://bom.so/dH3SlN"><img  class="img-item" src="https://media3.scdn.vn/img4/2021/12_02/uvudq1vD985lrKZV0sIk_simg_de2fe0_250x250_maxb.jpg" alt=""></a>
      <div class="logo">
        <div class="logoxahang">
          <img class="mot" src="https://media3.scdn.vn/img4/2021/04_16/BNnRsHfKT5xoQ7UKGWto.png" alt="ban ro rang">
        </div>
        <div class="iconshop">
          <span>THÙNG 300 KHẢU TRANG KF94 KHÁNG KHUẨN LOẠI DÀY ĐẸP - KHAUTRANG12</span>
        </div>
        <div class="gia">
